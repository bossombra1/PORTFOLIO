<template>
    <section class="text-white mt-20" id="contact">
        <h2 class="text-4xl font-bold text-white text-left mb-4 px-4 xl:pl-16">Prêt à
construire 
quelque chose ?</h2>
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <p class="text-[#adb7be]">Tu as un projet ? Travaillons ensemble.
                </p>
                <br>
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    ...
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>GitHub</h4>
                            <p>https://github.com/bossombra1</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form class="flex flex-col p-2" data-aos="zoom-in-up" >
                ...
                <div class="mb-6">
                    <label for="subject" class="text-white block mb-2 text-sm font-medium">Objet</label>
                ...
                <div class="mb-6">
                    ...
                    placeholder="Discutons de votre projet... " name="Message"></textarea>
                </div>
